...
- **Ventana**: redimensionable y maximizable. Se renderiza a la resolución lógica (1280×720) y pygame la escala manteniendo la proporción (`RESIZABLE | SCALED`, bandas negras si la relación no coincide); el mouse llega traducido a coordenadas lógicas.
